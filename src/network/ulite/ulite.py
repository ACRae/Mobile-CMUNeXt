...
class ULite(nn.Module):
    def __init__(self, input_channel=3, num_classes=1):
        ...
        """Encoder"""
        self.conv_in = nn.Conv2d(in_channels=input_channel, out_channels=16, kernel_size=7, padding="same")
        ...
        self.conv_out = nn.Conv2d(in_channels=16, out_channels=num_classes, kernel_size=1)
