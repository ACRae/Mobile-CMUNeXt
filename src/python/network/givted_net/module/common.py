...
class ConvNormAct(nn.Module):
    def __init__(self, in_chs, out_chs, kernel_size, stride=1, groups=1, norm="bn", act="relu"):
        ...
        assert act in [
            ...
            "hard_sigmoid",
            None,
        ], f"Activation function is not supported: {act}"
        self.act = act
...
class SqueezeExcite(nn.Module):
    def __init__(self, in_chs, se_ratio=0.25, divisor=4, dropout=0.0, **_):
